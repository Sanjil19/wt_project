...
<head>
  ...
  <style>
    /* Force Boxicons font for all .bx icons */
    .bx { font-family: 'boxicons' !important; font-style: normal; font-weight: normal; speak: never; }
    .bx.bx-search { color: #333 !important; font-size: 1.3em; vertical-align: middle; }
  </style>
  <!-- If you see a blue box instead of a search icon, check your internet connection or CDN access. -->
  <noscript><style>.bx { display:none !important; }</style></noscript>
  <!-- Google Fonts -->
    ...
    <div class="container">
      ...
      <div class="nav-right">
        <div id="search-bar">
          ...
          <button><i class="bx bx-search" style="color:#333;font-size:1.3em;"></i></button>
        </div>
    ...
    <section class="products">
      <div class="product-card">
        ...
        <div class="product-info">
          <h3>Acer Aspire 5</h3>
          <div class="price">$999.99 <span class="old-price">$1,199.99</span></div>
          <div class="rating">
          <!-- stars using boxicons -->
